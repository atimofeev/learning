...
№7: 18 Python Projects for your Resume
"""
...
reminders = [
    Reminder("Learn Python",
             today.strftime("%d:%m:%Y")),
    Reminder("Doctor's Appointment",
             (today + timedelta(days=7)).strftime("%d:%m:%Y")),
    Reminder("Dinner with Friends",
             (today + timedelta(days=14)).strftime("%d:%m:%Y")),
    Reminder("Birthday Party",
             (today + timedelta(days=21)).strftime("%d:%m:%Y")),
    Reminder("Work Presentation",
             (today + timedelta(days=30)).strftime("%d:%m:%Y")),
    Reminder("Annual Check-up",
             (today + timedelta(days=365)).strftime("%d:%m:%Y"))
]
    ...
    while True:
        ...
        while True:
            ...
            if rem_date.lower() == 'q':
                ...
                reminders.append(Reminder(rem_name,
                                          today.strftime("%d:%m:%Y")))
                return
            try:
